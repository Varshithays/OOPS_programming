...
public class Employeenew {
    ...
    public static String[] findDept(Employeen[] e, int s)
    {
    ...
    public static int findSecondHighestSalary(Employeen[] e, String d)
    {
        int[] sal = new int[0];
        for (int i = 0; i < e.length; i++) {
...
class Employeen
{
    ...
    String name, dept;
    public Employeen(int id, String name, String dept, int rating, int salary) {
        this.id = id;
        this.rating = rating;
        this.salary = salary;
        this.name = name;
